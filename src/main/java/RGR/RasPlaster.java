...
public class RasPlaster extends Ras{
	...
	public void setDatePlaster(double width, double length, double consumption, int layer,double price) {
		this.width = width;
		this.length = length;
		this.price = price;
